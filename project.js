...
function all_issues() {
    ...
    document.getElementById('closed_').innerText = ""
    ...
    fetch('https://phi-lab-server.vercel.app/api/v1/lab/issues')
        .then(response => response.json())
        .then(data => {
            const total = document.getElementById('open_')
            data.data.forEach(e => {
...
function open_issues() {
    ...
    document.getElementById('closed_btn').classList.remove('btn-primary')
    document.getElementById('open_btn').classList.add('btn-primary')
...
function closed_issues() {

    document.getElementById('total').innerText = ""
    document.getElementById('open_').innerText = ""
    document.getElementById('all_btn').classList.remove('btn-primary')
    document.getElementById('open_btn').classList.remove('btn-primary')
    document.getElementById('closed_btn').classList.add('btn-primary')
